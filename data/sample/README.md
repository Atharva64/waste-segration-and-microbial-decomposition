...
This directory contains documentation and small sample files related to the waste-classification dataset used in this project.

The complete dataset is **not stored in this GitHub repository** because of its large size.
